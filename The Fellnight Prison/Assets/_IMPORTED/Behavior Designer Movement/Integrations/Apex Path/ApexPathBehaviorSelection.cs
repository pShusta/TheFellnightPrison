...
public class ApexPathBehaviorSelection : MonoBehaviour
{
    ...
    private enum BehaviorSelectionType { Seek, Flee, Pursue, Evade, Patrol, Cover, Wander, Search, Flock, LeaderFollow, Queue, Last }
    ...
    private void SelectionChanged()
    {
        ...
        switch (selectionType) {
            ...
            case BehaviorSelectionType.Patrol:
                ...
                break;
            case BehaviorSelectionType.Cover:
                for (int i = 0; i < centerWalls.Length; ++i) {
                    centerWalls[i].layer = LayerMask.NameToLayer("Default");
                }
    ...
    private void DisableAll()
    {
        ...
        for (int i = 0; i < centerWalls.Length; ++i) {
            centerWalls[i].layer = LayerMask.NameToLayer("Ignore Raycast");
        }
        for (int i = 0; i < waypoints.Length; ++i) {
