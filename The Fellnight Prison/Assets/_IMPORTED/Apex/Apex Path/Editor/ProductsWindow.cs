    ...
    public class ProductsWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            if (_products == null)
            {
                ...
                EditorGUILayout.LabelField("Loading...", style, GUILayout.Width(450), GUILayout.Height(400));
                this.Repaint();
                return;
            }

            var rect = EditorGUILayout.BeginVertical(GUILayout.Width(450), GUILayout.Height(400));
        ...
        private void CreateFooter()
        {
            ...
            {
                _products = null;
                ProductManager.GetProductsInfoAsync(_settings, true, prods => _products = prods);
            }
