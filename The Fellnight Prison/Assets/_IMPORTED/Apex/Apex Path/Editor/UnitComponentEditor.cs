...
namespace Apex.Editor
{
    ...
    public class UnitComponentEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!_isPrefab && (GameServices.heightStrategy.useGlobalHeightNavigationSettings || GameServices.heightStrategy.heightMode == HeightSamplingMode.NoHeightSampling))
            {
        ...
        private void OnEnable()
        {
            ...
            _isPrefab = (PrefabUtility.GetPrefabType(this.target) == PrefabType.Prefab);
        }
